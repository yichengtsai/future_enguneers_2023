...
def print_mes():
    print('---------------')
    print('1, set the previous red threshold value')
    print('2, record redHSV')
    print('3, reset HSV value')
    print('4, set the previous green threshold value')
    print('5, record greenHSV')
    print('---------------')
